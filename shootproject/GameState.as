package  {
	...
	public class GameState extends State
	{
		...
		private function IniWalls(){
			...
			var p16:Platform=new Platform("p16",{x:4900,y:540,width:255,height:66});
			p16.oneWay=true;
			p16.view=new platforView1();
			add(p16);
			
			var p17:Platform=new Platform("p17",{x:4400,y:340,width:255,height:66});
			p17.oneWay=true;
			p17.view=new platforView1();
			add(p17);
			var p19:Platform=new Platform("p17",{x:2220,y:600,width:20,height:151});
			p19.oneWay=false;
		...
		private function IniEnemy(){
			...
			var enemy13:Enemy=new Enemy("enemy13",
				{x:4470,y:400,width:140,height:176,leftBound:4200,rightBound:4770});
